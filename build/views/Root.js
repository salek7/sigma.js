...
const RelationsPanel_1 = tslib_1.__importDefault(require("./RelationsPanel"));
...
const Root = () => {
    ...
    if (!dataset)
        return null;
    return ((0, jsx_runtime_1.jsx)("div", { id: "app-root", className: showContents ? "show-contents" : "", children: (0, jsx_runtime_1.jsxs)(core_1.SigmaContainer, { graph: graph, settings: sigmaSettings, className: "react-sigma", children: [(0, jsx_runtime_1.jsx)(GraphSettingsController_1.default, { hoveredNode: hoveredNode }), (0, jsx_runtime_1.jsx)(GraphEventsController_1.default, { setHoveredNode: setHoveredNode, setSelectedNode: setSelectedNode }), (0, jsx_runtime_1.jsx)(GraphDataController_1.default, { filters: filtersState }), dataReady && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("button", { className: "theme-switcher", onClick: () => setDarkMode(!darkMode), title: darkMode ? "Przełącz na tryb jasny" : "Przełącz na tryb ciemny", children: darkMode ? (0, jsx_runtime_1.jsx)(bs_1.BsSun, {}) : (0, jsx_runtime_1.jsx)(bs_1.BsMoon, {}) }), (0, jsx_runtime_1.jsx)(GraphTitle_1.default, { filters: filtersState }), (0, jsx_runtime_1.jsxs)("div", { className: "controls", children: [(0, jsx_runtime_1.jsx)("div", { className: "react-sigma-control ico", children: (0, jsx_runtime_1.jsx)("button", { type: "button", className: "show-contents", onClick: () => setShowContents(true), title: "Show caption and description", children: (0, jsx_runtime_1.jsx)(bi_1.BiBookContent, {}) }) }), (0, jsx_runtime_1.jsxs)(core_1.FullScreenControl, { className: "ico", children: [(0, jsx_runtime_1.jsx)(bs_1.BsArrowsFullscreen, {}), (0, jsx_runtime_1.jsx)(bs_1.BsFullscreenExit, {})] }), (0, jsx_runtime_1.jsxs)(core_1.ZoomControl, { className: "ico", children: [(0, jsx_runtime_1.jsx)(bs_1.BsZoomIn, {}), (0, jsx_runtime_1.jsx)(bs_1.BsZoomOut, {}), (0, jsx_runtime_1.jsx)(bi_1.BiRadioCircleMarked, {})] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "contents", children: [(0, jsx_runtime_1.jsx)("div", { className: "ico", children: (0, jsx_runtime_1.jsx)("button", { type: "button", className: "hide-contents", onClick: () => setShowContents(false), title: "Show caption and description", children: (0, jsx_runtime_1.jsx)(gr_1.GrClose, {}) }) }), (0, jsx_runtime_1.jsxs)("div", { className: "panels", children: [(0, jsx_runtime_1.jsx)(SearchField_1.default, { filters: filtersState }), (0, jsx_runtime_1.jsx)(DescriptionPanel_1.default, { selectedNode: selectedNode }), (0, jsx_runtime_1.jsx)(RelationsPanel_1.default, { selectedNode: selectedNode }), (0, jsx_runtime_1.jsx)(ClustersPanel_1.default, { clusters: dataset.clusters, filters: filtersState, setClusters: (clusters) => setFiltersState((filters) => (Object.assign(Object.assign({}, filters), { clusters }))), toggleCluster: (cluster) => {
