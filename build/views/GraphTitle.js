...
const GraphTitle = ({ filters }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "graph-title", children: [(0, jsx_runtime_1.jsx)("h1", { children: "AI knowledge graph" }), (0, jsx_runtime_1.jsx)("h2", { children: (0, jsx_runtime_1.jsxs)("i", { children: [graph.order, " node", graph.order > 1 ? "s" : "", " ", visibleItems.nodes !== graph.order
